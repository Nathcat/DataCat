<div class="navbar column align-center justify-center">
    <div style="width: 100%; justify-content: start;" class="row align-center">
        <img style="margin-top: 20px;" width="100" height="100" src="https://data.nathcat.net/sso/AuthCat.png">
