            ...
            <script>
                get_groups((r) => {
                    r.owned.forEach(element => {
                        document.getElementById("owned-group-list").innerHTML += "<div class='content-card app-record group-record' style='width: 100%; margin: 10px;' onclick=\"goto('/data/group/?id=" + element.id + "')\"><h3>" + element.name + "</h3><span class='quarter-spacer'></span><h4>Created by <i>" + element.ownerUsername + "</i></h4></div>";
                    });
                    ...
                    r.memberOf.forEach(element => {
                        document.getElementById("member-group-list").innerHTML += "<div class='content-card app-record group-record' style='width: 100%; margin: 10px;' onclick=\"goto('/data/group/?id=" + element.id + "')\"><h3>" + element.name + "</h3><span class='quarter-spacer'></span><h4>Created by <i>" + element.ownerUsername + "</i></h4></div>";
                    });
