            ...
            <script>
                get_groups((r) => {
                    r.owned.forEach(element => {
                        document.getElementById("owned-group-list").innerHTML += "<div class='content-card app-record' style='width: 100%; margin: 10px;'><h3>" + element.name + "</h3></div>";
                    });
                    ...
                    r.memberOf.forEach(element => {
                        document.getElementById("member-group-list").innerHTML += "<div class='content-card app-record' style='width: 100%; margin: 10px;'><h3>" + element.name + "</h3></div>";
                    });
